...
@Component({
  selector: 'app-franke-banner-left',
  templateUrl: './franke-banner-left.component.html',
  styleUrls: ['./franke-banner-left.component.scss'],
})
export class FrankeBannerLeftComponent implements OnInit, OnDestroy {
